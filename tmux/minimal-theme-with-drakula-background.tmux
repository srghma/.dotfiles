...
default_color="#[bg=#08080a,fg=#ffffff,bold]"
...
"$show_expanded_icon_for_all_tabs" && tmux set-option -g window-status-format "#[bg=#08080a,fg=#ffffff] ${window_status_format}#{?window_zoomed_flag,${expanded_icon},}"
