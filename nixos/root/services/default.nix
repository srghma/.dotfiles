...

{
  ...
  xserver = {
    ...
    displayManager = {
      ...
      # ${xkbcomp}/bin/xkbcomp ${../../../layouts/en_ru} $DISPLAY &
      # nix-shell -p xkbcomp --run "xkbcomp /home/srghma/.dotfiles/layouts/en_ru_swapped $DISPLAY"
      #sessionCommands = ''
      #  ${xkbcomp}/bin/xkbcomp /home/srghma/.dotfiles/layouts/en_ua_swapped $DISPLAY
      #'';
    };
  };
