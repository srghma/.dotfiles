...
;;       :nv "g^" #'evil-first-non-blank-of-visual-line)
...
;;   :mode "\\.idr\\'"
;;   :hook (idris2-mode . idris2-auto-mode))
...
(use-package! idris2-mode
  ...
  (map! :localleader
        :map idris2-mode-map
        "g" #'idris2-jump-to-def
        "G" #'idris2-jump-to-def-same-window
...
(custom-set-faces
 '(menu ((t (:background "#333333" :foreground "#ffffff"))))) ;; Dark gray bg, white text

(menu-bar-mode 1)
;; (setq doom-theme 'doom-nord) ;; or 'doom-gruvbox, 'doom-nord, etc.
